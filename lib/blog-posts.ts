...
export const posts: BlogPost[] = [
  {
    slug: "why-reading-feels-difficult-now",
    href: "/blog/why-reading-feels-difficult-now",
    title: "Why Reading Feels So Difficult Now",
    description:
      "You open a book, read three paragraphs, and reach for your phone. It’s not that books got boring — your brain learned a different rhythm. Here’s why stillness feels hard, and how to get lost in a page again.",
    date: "2026-09-08",
    readingMinutes: 6,
    category: "habits",
    tags: ["attention", "focus", "deep-reading", "habits", "boredom"],
    keywords: [
      "why reading feels difficult",
      "can't focus on reading",
      "hard to read books anymore",
      "reading attention span",
      "why I can't finish books",
    ],
  },
  {
    slug: "history-of-silent-reading",
    href: "/blog/history-of-silent-reading",
    title: "The Strange History of Reading Silently",
    description:
      "For much of history, reading was meant to be heard. From Augustine’s surprise at Ambrose to printing and the novel — how silent reading became normal, and what today’s fragment flood asks of us.",
    date: "2026-09-08",
    readingMinutes: 7,
    category: "habits",
    tags: ["history", "silent-reading", "deep-reading", "habits", "attention"],
    keywords: [
      "history of silent reading",
      "when did people start reading silently",
      "reading aloud history",
      "St Augustine Ambrose silent reading",
      "history of reading books",
    ],
  },
  {
    slug: "reading-is-time-travel",
    href: "/blog/reading-is-time-travel",
    title: "Reading Is the Closest Thing We Have to Time Travel",
    description:
      "A book lets someone who lived centuries ago occupy your mind for an afternoon. Why deep reading expands one lifetime into many — and how to protect that rare kind of attention.",
    date: "2026-09-08",
    readingMinutes: 7,
    category: "habits",
    tags: ["deep-reading", "habits", "attention", "books", "why-read"],
    keywords: [
      "reading is time travel",
      "why reading matters",
      "power of reading books",
      "deep reading attention",
      "why you should read books",
    ],
  },
  {
    slug: "smartphones-killing-attention-span",
    href: "/blog/smartphones-killing-attention-span",
    title: "Are Smartphones Killing Our Attention Span? What the Research Says",
    description:
      "Phone notifications, endless feeds, and fragmented focus are reshaping how long we can stay with a page. Here’s what the evidence shows — and how to rebuild deep attention for reading.",
    date: "2026-09-08",
    readingMinutes: 8,
    category: "science",
    tags: ["attention", "focus", "smartphones", "deep-reading", "habits"],
    keywords: [
      "are smartphones killing our attention span",
      "smartphone attention span",
      "phone distraction reading",
      "attention span and phones",
      "how phones affect reading focus",
    ],
  },
  {
    slug: "tiktok-changing-how-we-read",
    href: "/blog/tiktok-changing-how-we-read",
    title: "Is TikTok Changing How We Read? Short-Form Video and Attention",
    description:
      "Short-form video trains the brain for rapid novelty. Learn how TikTok-style feeds affect reading stamina, comprehension, and what you can do to protect deep reading habits.",
    date: "2026-09-08",
    readingMinutes: 7,
    category: "science",
    tags: ["tiktok", "attention", "deep-reading", "habits", "focus"],
    keywords: [
      "is TikTok changing how we read",
      "TikTok reading attention",
      "short form video reading",
      "TikTok effect on reading",
      "social media and reading habits",
    ],
  },
  {
    slug: "why-people-read-shorter-content",
    href: "/blog/why-people-read-shorter-content",
    title: "Why Are People Reading Shorter Things? The Shift to Skim Culture",
    description:
      "From headlines to threads, attention economics push us toward shorter text. Here’s why long-form is declining, what we lose when we only skim, and how to reclaim deep reading.",
    date: "2026-09-08",
    readingMinutes: 7,
    category: "science",
    tags: ["skimming", "deep-reading", "habits", "attention", "comprehension"],
    keywords: [
      "why are people reading shorter things",
      "short content reading habits",
      "decline of long form reading",
      "skim culture",
      "why people skim instead of read",
    ],
  },
  {
    slug: "ebooks-vs-physical-books",
    href: "/blog/ebooks-vs-physical-books",
    title: "Are E-Books Better Than Physical Books? A Research-Backed Comparison",
    description:
      "Comprehension, retention, convenience, and cost — an honest comparison of e-books vs print. When screens win, when paper wins, and how to get more from digital reading.",
    date: "2026-09-08",
    readingMinutes: 8,
    category: "comparison",
    tags: ["ebooks", "print", "comprehension", "comparison", "habits"],
    keywords: [
      "are ebooks better than physical books",
      "ebooks vs physical books",
      "ebook vs paperback comprehension",
      "digital reading vs print",
      "are e-books as good as print",
    ],
  },
  {
    slug: "kindle-vs-physical-books",
    href: "/blog/kindle-vs-physical-books",
    title: "Kindle vs Physical Books: Which Should You Choose in 2026?",
    description:
      "E-ink, portability, cost per book, and reading feel — a practical Kindle vs hardcover guide. Plus how to stay focused and finish more whether you read on paper or screen.",
    date: "2026-09-08",
    readingMinutes: 7,
    category: "comparison",
    tags: ["kindle", "ebooks", "print", "comparison", "habits"],
    keywords: [
      "Kindle vs physical books",
      "Kindle vs paperback",
      "is Kindle better than books",
      "Kindle or hardcover",
      "e-ink vs print reading",
    ],
  },
  {
    slug: "does-blue-light-affect-reading",
    href: "/blog/does-blue-light-affect-reading",
    title: "Does Blue Light Affect Reading? Sleep, Eyes, and Screen Habits",
    description:
      "Blue light, melatonin, eye strain, and late-night reading — what studies actually support. Practical tips to protect sleep and focus without giving up digital books.",
    date: "2026-09-08",
    readingMinutes: 7,
    category: "science",
    tags: ["blue-light", "sleep", "screens", "focus", "habits"],
    keywords: [
      "does blue light affect reading",
      "blue light reading sleep",
      "blue light eye strain reading",
      "reading on screens at night",
      "blue light filter reading",
    ],
  },
  {
